package net.ivanvega.basededatosconrooma.provider;
...
public class MiProveedorContenido
    ...
    /*
        content://net.ivanvega.basededatosconrooma.provider/usuario ->  insert y query
        content://net.ivanvega.basededatosconrooma.provider/usuario/# -> delete, query y update
        content://net.ivanvega.basededatosconrooma.provider/usuario/*  ->  query
    ...
    static
    {
        sURIMatcher.addURI("net.ivanvega.basededatosconrooma.provider",
                "usuario", 1);
        sURIMatcher.addURI("net.ivanvega.basededatosconrooma.provider",
                "usuario/#", 2);
        sURIMatcher.addURI("net.ivanvega.basededatosconrooma.provider",
    ...
    public String getType(@NonNull Uri uri) {
        ...
        /*Tipos MIME
            ...
            vnd.android.cursor.item/vnd.net.ivanvega.basededatosconrooma.provider.usuario
            vnd.android.cursor.dir/vnd.net.ivanvega.basededatosconrooma.provider.usuario
        ...
        switch (sURIMatcher.match(uri)){
            case 1:
                tipoMIME = "vnd.android.cursor.dir/vnd.net.ivanvega.basededatosconrooma.provider.usuario";
                break;

            case 2:
                tipoMIME = "vnd.android.cursor.item/vnd.net.ivanvega.basededatosconrooma.provider.usuario";
